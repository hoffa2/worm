...
type Election struct {
	...
	Newtarget *Target `protobuf:"bytes,2,opt,name=newtarget" json:"newtarget,omitempty"`
}

func (m *Election) Reset()                    { *m = Election{} }
func (m *Election) String() string            { return proto.CompactTextString(m) }
func (*Election) ProtoMessage()               {}
func (*Election) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }

func (m *Election) GetState() int32 {
	if m != nil {
		return m.State
	}
	return 0
...
func (m *Election) GetNewtarget() *Target {
	if m != nil {
		return m.Newtarget
	}
	return nil
...
type Gossip_Election struct {
	Election *Election `protobuf:"bytes,1,opt,name=election,oneof"`
}

func (*Gossip_Election) isGossip_Msg() {}
...
func (m *Gossip) GetElection() *Election {
	if x, ok := m.GetMsg().(*Gossip_Election); ok {
		return x.Election
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*Gossip)(nil), "Gossip")
}
...
var fileDescriptor0 = []byte{
	...
	,
}
