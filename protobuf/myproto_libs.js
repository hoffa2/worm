...
proto.FromClient.toObject = function(includeInstance, msg) {
  var f, obj = {
    changetarget: (f = msg.getChangetarget()) && proto.target.toObject(includeInstance, f),
...
/**
 * optional target changeTarget = 1;
 * @return {?proto.target}
 */
...
proto.FromClient.prototype.setChangetarget = function(value) {
  jspb.Message.setOneofWrapperField(this, 1, proto.FromClient.oneofGroups_[0], value);
};


proto.FromClient.prototype.clearChangetarget = function() {
  this.setChangetarget(undefined);
};
